    ...
    <div className="Home">
      ...
      <div className="home-part2">
        <div className="content">
          <h5>What we do</h5>
          <h1>Our Misson</h1>
          <p><strong>One of the biggest bottlenecks in innovation and solution-finding is the difficulty in sourcing talented people to support these efforts.</strong></p>
          ...
          <center>***</center>
          <p><strong>We are a group of students from Stanford University who want to help in the fight against COVID-19. We’ve experienced firsthand the difficulty of bringing together a team of talented individuals to bring our ideas to fruition. As students ourselves, we’ve also seen internships, jobs, and research positions cancelled, leaving plenty of talented people without opportunities to do something they’re passionate about.</strong></p>
