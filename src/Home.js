    ...
    <div className="Home">
      ...
      <div className="home-part2">
        <div className="content">
          ...
          <p>We’ve experienced firsthand the difficulty of bringing together a team of talented individuals to bring our ideas to fruition. As students ourselves, we’ve also seen internships, jobs, and research positions cancelled, leaving plenty of talented people without opportunities to do something they’re passionate about. That’s why we started hackCOVID, where we hope we can bridge the gap between great ideas and even greater people.</p>
        </div>
      </div>
    </div>
  )
