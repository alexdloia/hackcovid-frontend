    ...
    <div className="Home">
      ...
      <div className="home-part2">
        <div className="content">
          <h5>What we do</h5>
          <h1>Our Misson</h1>
          <p><strong>One of the biggest bottlenecks in innovation and solution-finding is the difficulty in finding talented people to bring ideas to life.</strong></p>
          ...
          <center>***</center>
          <p><strong>We are a group of students from Stanford University who want to help in the fight against COVID-19, backed by the Stanford COVID-19 Response Innovation Lab.</strong></p>
          <p>We’ve experienced firsthand the difficulty of bringing together a team of talented individuals to bring our ideas to fruition. As students ourselves, we’ve also seen internships, jobs, and research positions cancelled, leaving plenty of talented people searching for opportunities to do something they’re passionate about. That’s why we started hackCOVID, where we hope to bridge the gap between great ideas and even greater people.</p>
        </div>
      </div>
    </div>
  )
